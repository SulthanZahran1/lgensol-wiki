...
sources:
  ...
  - raw/ko/uncategorized/contract-department-of-lgenergysolution-story.md
...
## Snapshot
Bipolar battery architecture connects cells internally in series through shared current collectors. In this wiki, it is cross-referenced with [[mah|mAh (milliampere-hour)]], [[mid-nickel-battery|High-Voltage Mid-Nickel Battery]], and [[ncm-battery|NCM (Ternary) Battery]].
