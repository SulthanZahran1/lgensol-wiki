...
## Snapshot
Sodium-ion batteries replace lithium-ion charge carriers with sodium ions to reduce material cost and supply pressure. In this wiki, it is cross-referenced with [[lfp-battery|LFP (Lithium Iron Phosphate) Battery]], [[active-material|Active Material]], and [[anodeless-battery|Anodeless Battery]].
