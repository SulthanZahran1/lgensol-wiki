...
## Snapshot
Lithium-sulfur batteries pair a sulfur-based cathode with a lithium-metal anode for lightweight, high-energy applications. In this wiki, it is cross-referenced with [[lithium-metal-battery|Lithium Metal Battery]], [[uam-battery|Batteries for UAM]], and [[dendrite|Dendrite]].
