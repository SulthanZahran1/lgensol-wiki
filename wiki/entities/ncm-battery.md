...
## Snapshot
NCM batteries use nickel, cobalt, and manganese cathodes and are a mainstream EV lithium-ion chemistry. In this wiki, it is cross-referenced with [[lfp-vs-ncm|LFP vs NCM Comparison]], [[high-nickel-battery|High-Nickel Battery]], and [[ncma-battery|NCMA (Quaternary) Battery]].
