...
updated: 2026-06-05
type: entity
tags: [partnership, ess, ev, cylindrical, 46-series]
sources:
...
## Snapshot
Tesla appears in the corpus as an ESS partner/customer for LG Energy Solution battery supply. In this wiki, it is cross-referenced with [[lg-energy-solution|LG Energy Solution]], [[energy-storage-system|ESS (Energy Storage System)]], and [[lfp-battery|LFP (Lithium Iron Phosphate) Battery]].
