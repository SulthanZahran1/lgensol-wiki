...
## Definition
The potential window is the voltage range over which an electrolyte or material remains electrochemically stable.

## Why It Matters
- Exceeding it causes decomposition, gas, interphase growth, or safety problems.
...
The term is used as a precise retrieval handle for posts about [[bipolar-technology|Bipolar Technology]], [[mah|mAh (milliampere-hour)]], and [[mid-nickel-battery|High-Voltage Mid-Nickel Battery]].
