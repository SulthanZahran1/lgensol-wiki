...
## Definition
mAh, or milliampere-hour, is a capacity unit equal to current in milliamps multiplied by time in hours.

## Why It Matters
- It is useful for small cells but must be paired with voltage to compare energy.
...
The term is used as a precise retrieval handle for posts about [[bipolar-technology|Bipolar Technology]], [[mid-nickel-battery|High-Voltage Mid-Nickel Battery]], and [[ncm-battery|NCM (Ternary) Battery]].
