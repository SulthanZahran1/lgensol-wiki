...
## Definition
A BBU, or Battery Backup Unit, supplies backup power when the primary power source fails.

## Why It Matters
- It is critical for data centers, telecom, factories, and grid-connected infrastructure.
...
The term is used as a precise retrieval handle for posts about [[lfp-battery|LFP (Lithium Iron Phosphate) Battery]], [[ups|UPS (Uninterruptible Power Supply)]], and [[avel|AVEL]].
